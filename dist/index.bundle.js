...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"appEvents\": () => (/* binding */ appEvents)\n/* harmony export */ });\n/* harmony import */ var _appComponents__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appComponents */ \"./src/appComponents.js\");\n\n\nconst appEvents = (function() {\n    function computerTurn() {\n        let location = Math.floor( Math.random() * 49 );\n\n        if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.boardArray[location].isAttacked === 'empty' ) {\n            _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.recordAttack( location );\n            if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.boardArray[location].isAttacked === 'shot' ) {\n                document.getElementById( `${location}` ).style.backgroundColor = 'gold';\n                document.getElementById( `${location}` ).innerText = 'X';\n            } else if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.boardArray[location].isAttacked === 'missed' ) {\n                document.getElementById( `${location}` ).style.backgroundColor = 'pink';\n            } \n        } else {\n            computerTurn();\n        };\n    };\n\n    function checkPlayerWin() {\n        _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.checkSunkShips();\n\n        if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.shipList[0].sunkStatus === true && _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.shipList[1].sunkStatus === true &&\n            _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.shipList[2].sunkStatus === true && _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.shipList[3].sunkStatus === true &&\n            _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.shipList[4].sunkStatus === true ) {\n            alert( 'Player Wins' );\n        }\n    };\n\n    function checkComWin() {\n        _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.checkSunkShips();\n\n        if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.shipList[0].sunkStatus === true && _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.shipList[1].sunkStatus === true &&\n            _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.shipList[2].sunkStatus === true && _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.shipList[3].sunkStatus === true &&\n            _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.playerBoard.shipList[4].sunkStatus === true ) {\n            console.log( 'computer wins' );\n        }\n    };\n\n    function comCellEvents() {\n        document.querySelectorAll( '.com-cell' ).forEach( (cell) => cell.addEventListener( 'click', function() {\n            let cellIndex = cell.id;\n\n            if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.boardArray[cellIndex].isAttacked === 'empty' ) {\n                _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.recordAttack( cellIndex );\n                if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.boardArray[cellIndex].isAttacked === 'shot' ) {\n                    this.style.backgroundColor = 'gold';\n                    this.innerText = 'X';\n                } else if( _appComponents__WEBPACK_IMPORTED_MODULE_0__.appComponents.comBoard.boardArray[cellIndex].isAttacked === 'missed' ) {\n                    this.style.backgroundColor = 'pink';\n                };\n                computerTurn();\n                checkPlayerWin();\n                checkComWin();\n            } else {\n                return;\n            };\n\n        })); \n    };\n\n    return {\n        comCellEvents,\n    };\n})();\n\n\n\n//# sourceURL=webpack://space-battleship/./src/appEvents.js?");
